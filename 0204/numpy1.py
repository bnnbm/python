...
print(arr)
arr = np.ones((3,5),dtype=float) #3행5열 리스트생성. 1로 채움
print(arr)
arr = np.full((3,5),3.14) #3행5열 리스트 생성. 3.14로 채움
print(arr)
...
print(arr)
#평균0, 표준 편차 1의 정규 분포를 따르는 3*3 난수 배열
...
print(arr.ndim) #각 차원의 크기 리턴
print(arr.ndim) #전체 배열의 크기. 전체 요소의 갯수. 3*3
print(arr.ndim) #배열 요소의 자료형